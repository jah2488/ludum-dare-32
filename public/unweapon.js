...
Opal.modules["lib/game"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    def.camera = nil;
    self.$attr_reader("width", "height", "tilesize");
...
Opal.modules["lib/camera"] = function(Opal) {
  ...
  Opal.add_stubs(['$attr_accessor', '$width', '$height', '$new', '$draw_rect', '$x', '$tracking', '$y', '$speed', '$button_down?', '$clamp', '$[]', '$bounds']);
  return (function($base, $super) {
    function $Camera(){};
    ...
    def.bounds = def.tracking = def.x = def.y = nil;
    ...
    def.$tracking = function() {
      ...
      return ((($a = self.tracking) !== false && $a !== nil) ? $a : $scope.get('Struct').$new("x", "y", "speed").$new(self.x, self.y, 1));
    };
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$attr_reader', '$new', '$draw', '$mid', '$x', '$camera', '$pixel_width', '$y', '$pixel_height', '$draw_rect', '$width', '$tilesize', '$height', '$set_camera', '$track', '$update', '$run!']);
  self.$require("dare");
  ...
  (function($base, $super) {
    ...
    def.$draw = function(ctx) {
      var $a, self = this, offset_x = nil, offset_y = nil;
      ...
      return ctx.$draw_rect($hash2(["top_left", "width", "height", "color"], {"top_left": [offset_x, offset_y], "width": self.$pixel_width(), "height": self.$pixel_height(), "color": "goldenrod"}));
    };
    ...
    return (def.$pixel_height = function() {
      var self = this;
  ...
  (function($base, $super) {
    ...
    def.camera = def.player = def.level = nil;
    def.$initialize = TMP_1 = function() {
      ...
      return self.camera.$track(self.player);
    };
