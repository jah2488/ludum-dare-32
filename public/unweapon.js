  ...
  return (function($base, $super) {
    ...
    def.$draw = function(ctx) {
      ...
      if ((($a = self.$tracking()) !== nil && (!$a.$$is_boolean || $a == true))) {
        ctx.$draw_rect($hash2(["top_left", "width", "height", "color"], {"top_left": [self.$tracking().$x(), self.$tracking().$y()], "width": 20, "height": 20, "color": "black"}))};
      return ctx.$draw_rect($hash2(["top_left", "width", "height", "color"], {"top_left": [self.$x(), self.$y()], "width": 20, "height": 20, "color": "black"}));
    };
...
Opal.modules["lib/item"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    def.$draw = function(ctx) {
      ...
      if ((($a = self['$near_player?'](50)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return self.font.$draw(self.$name(), self.$x(), $rb_plus(self.$y(), $rb_divide(self.$height(), 2)))
        } else {
        return nil
      };
    };
...
(function(Opal) {
  ...
  (function($base, $super) {
    ...
    def.$initialize = TMP_1 = function() {
      ...
      self.level = $scope.get('Level').$new();
      self.level.$set_items(($a = ($b = $scope.get('Array')).$new, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;
      ...
      return (($c = [$hash2(["x", "y"], {"x": [$rb_times(($rb_divide(self.level.$pixel_width(), 4)), -1), self.level.$pixel_width()], "y": [$rb_times(($rb_divide(self.level.$pixel_height(), 4)), -1), self.level.$pixel_height()]})]), $d = self.camera, $d['$bounds='].apply($d, $c), $c[$c.length-1]);
    };
