...
/* Generated by Opal 0.7.0.beta3 */
Opal.modules["lib/game"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  function $rb_divide(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs / rhs : lhs['$/'](rhs);
  }
  ...
  Opal.add_stubs(['$attr_reader', '$mid_x', '$mid_y', '$width', '$height', '$clamp']);
  return (function($base, $super) {
    function $Game(){};
    ...
    def.$initialize = function(width, height, tilesize) {
      ...
      self.width = width;
      self.height = height;
      return self.tilesize = tilesize;
    };

    def.$current_level = function() {
      var self = this;

      return self.current_level;
    };

    def.$set_level = function(level) {
      var self = this;
    ...
    def.$mid_x = function() {
      ...
      return $rb_divide(self.$width(), 2);
    };

    def.$mid_y = function() {
      var self = this;

      return $rb_divide(self.$height(), 2);
    };

    def.$clamp = function(var$, lower, upper) {
      var self = this;
    ...
    def.$bounds_clamp_x = function(var$) {
      var self = this;
...
/* Generated by Opal 0.7.0.beta3 */
Opal.modules["lib/camera"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  ...
  Opal.add_stubs(['$attr_accessor', '$width', '$height', '$tracking', '$speed', '$moving=', '$button_down?', '$on_move', '$clamp', '$[]', '$bounds']);
  return (function($base, $super) {
    function $Camera(){};
...
/* Generated by Opal 0.7.0.beta3 */
Opal.modules["lib/utils/dir"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;
...
/* Generated by Opal 0.7.0.beta3 */
Opal.modules["lib/utils/animation"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$attr_accessor', '$new']);
  return (function($base, $super) {
    function $Animation(){};
    ...
    self.$attr_accessor("start", "finish", "on_finished");

    return (def.$initialize = function(start, finish, on_finished) {
      var self = this;

      if (on_finished == null) {
        on_finished = $scope.get('Null').$new()
      }
      self.start = start;
      self.finish = finish;
      return self.on_finished = on_finished;
    }, nil) && 'initialize';
  })(self, null)
};

/* Generated by Opal 0.7.0.beta3 */
Opal.modules["lib/utils/null"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;
...
/* Generated by Opal 0.7.0.beta3 */
Opal.modules["lib/sprite"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  function $rb_gt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs > rhs : lhs['$>'](rhs);
  }
  ...
  Opal.add_stubs(['$length', '$finish', '$call', '$on_finished', '$start', '$new', '$img', '$[]', '$[]=', '$width', '$height', '$times', '$<<', '$to_i']);
  return (function($base, $super) {
    function $Sprite(){};
    var self = $Sprite = $klass($base, $super, 'Sprite', $Sprite);
    ...
    def.frames = def.tick = def.current_frame = def.current_animation = def.tiles = nil;
    ...
    def.$step_animation = function() {
      ...
      if ($rb_ge(self.current_frame, self.current_animation.$finish())) {
        self.current_animation.$on_finished().$call();
    ...
    return (def.$load_tiles = function(path, opts) {
      var $a, $b, $c, TMP_1, self = this, image = nil, columns = nil, rows = nil;
      ...
      image = (($scope.get('Dare')).$$scope.get('Image')).$new(path);
      self.tiles = [];
...
if (row == null) row = nil;
      return ($a = ($b = columns).$times, $a.$$p = (TMP_2 = function(column){var self = TMP_2.$$s || this;
          if (self.tiles == null) self.tiles = nil;
if (column == null) column = nil;
        return self.tiles['$<<']((($scope.get('Dare')).$$scope.get('ImageTile')).$new(image, $rb_times(column, opts['$[]']("width").$to_i()), $rb_times(row, opts['$[]']("height").$to_i()), opts['$[]']("width").$to_i(), opts['$[]']("height").$to_i()))}, TMP_2.$$s = self, TMP_2), $a).call($b)}, TMP_1.$$s = self, TMP_1), $a).call($b);
      }
    ;
      return self.tiles;
    }, nil) && 'load_tiles';
...
Opal.modules["lib/player"] = function(Opal) {
  ...
  Opal.add_stubs(['$attr_accessor', '$load_tiles', '$new', '$lambda', '$kill', '$mid', '$x=', '$camera', '$y=', '$frames_loaded?', '$draw', '$[]', '$moving?', '$step_animation', '$draw_rect', '$finish', '$call', '$on_finished', '$start', '$length', '$coords', '$upper_level_bounds', '$lower_level_bounds', '$button_down?', '$nil?', '$drop_item', '$!', '$==', '$===', '$held=', '$pixel_width', '$current_level', '$width', '$pixel_height', '$height', '$-@', '$mid_x', '$offset_x', '$mid_y', '$offset_y']);
  return (function($base, $super) {
    function $Player(){};
    ...
    def.walk = def.in_water = def.drown = def.frames = def.current_frame = def.pickup = def.tick = def.current_animation = def.item = def.moving = def.facing = def.left = def.right = def.back = nil;
    ...
    def.$initialize = function() {
      ...
      self.x = self.y = 0;
      self.frames = (($scope.get('Dare')).$$scope.get('Image')).$load_tiles("assets/anim_player2.png", $hash2(["width", "height"], {"width": 32, "height": 32}));
      self.walk = $scope.get('Animation').$new(0, 5);
      self.back = $scope.get('Animation').$new(6, 11);
      self.right = $scope.get('Animation').$new(12, 14);
      self.left = $scope.get('Animation').$new(15, 18);
      self.splash = $scope.get('Animation').$new(18, 21);
      self.drown = $scope.get('Animation').$new(24, 30, ($a = ($b = self).$lambda, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;

      return self.$kill()}, TMP_1.$$s = self, TMP_1), $a).call($b));
    ...
    def.$kill = function() {
      ...
      $a = Opal.to_ary($scope.get('G').$mid()), $scope.get('G').$camera()['$x='](($a[0] == null ? nil : $a[0])), $scope.get('G').$camera()['$y='](($a[1] == null ? nil : $a[1]));
      self.facing = (($scope.get('DIR')).$$scope.get('DOWN'));
      self.current_animation = self.walk;
    ...
    def.$draw = function(ctx) {
      ...
      if ((($a = self['$frames_loaded?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
        if ((($a = self.in_water) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.current_animation = self.drown;
          self.moving = true;};
    ...
    def.$update = function(ctx) {
      ...
      if ((($a = ctx['$button_down?']((($scope.get('Dare')).$$scope.get('KbSpace')))) !== nil && (!$a.$$is_boolean || $a == true))) {
        if ((($a = self.item['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.pickup = true
          } else {
          self.pickup = false
        };
...
Opal.modules["lib/level"] = function(Opal) {
  ...
  Opal.add_stubs(['$[]', '$[]=', '$context', '$attr_reader', '$set_item_placement', '$new', '$with_index', '$each_with_index', '$x=', '$tilesize', '$y=', '$each_slice', '$Array', '$each', '$random_placement', '$items', '$x', '$y', '$offset_x', '$offset_y', '$draw', '$draw_square', '$offset', '$pixels', '$enemies', '$draw_rect', '$update', '$camera', '$pixel_width', '$pixel_height', '$width', '$height', '$sample', '$select', '$to_proc']);
  (function($base) {
    var self = $module($base, 'Dare');
    ...
    (function($base, $super) {
      ...
      def.canvas = def.img = nil;
      return (def.$tile = function(x, y, opts) {
        var $a, $b, $c, self = this, ctx = nil, pattern = nil;
        ...
        pattern = ctx.createPattern(self.img, 'repeat');
  ...
  return (function($base, $super) {
    ...
    def.bg = nil;
    self.$attr_reader("x", "y", "width", "height", "enemies", "items");

    def.$initialize = function(x, y, width, height, enemies, items) {
      ...
      self.items = items;
      self.$set_item_placement();
      self.bg = ($a = ($b = $scope.get('Array')).$new, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;

      return $scope.get('Item').$new("grass")}, TMP_1.$$s = self, TMP_1), $a).call($b, $rb_times(width, height));
      return ($a = ($c = self.bg.$each_slice(width)).$with_index, $a.$$p = (TMP_2 = function(tiles, row_index){var self = TMP_2.$$s || this, $a, $b, TMP_3;
if (tiles == null) tiles = nil;if (row_index == null) row_index = nil;
      return ($a = ($b = tiles).$each_with_index, $a.$$p = (TMP_3 = function(tile, col_index){var self = TMP_3.$$s || this, $a, $b;
if (tile == null) tile = nil;if (col_index == null) col_index = nil;
        (($a = [$rb_plus($rb_times($scope.get('G').$tilesize(), col_index), 1)]), $b = tile, $b['$x='].apply($b, $a), $a[$a.length-1]);
          return (($a = [$rb_plus($rb_times($scope.get('G').$tilesize(), row_index), 1)]), $b = tile, $b['$y='].apply($b, $a), $a[$a.length-1]);}, TMP_3.$$s = self, TMP_3), $a).call($b)}, TMP_2.$$s = self, TMP_2), $a).call($c);
    };

    def.$set_enemies = function(enemies) {
      var self = this;

      return self.enemies = self.$Array(enemies);
    };

    def.$set_items = function(items) {
      var self = this;

      self.items = self.$Array(items);
      return self.$set_item_placement();
    };

    def.$set_item_placement = function() {
      var $a, $b, TMP_4, self = this;

      return ($a = ($b = self.$items()).$each, $a.$$p = (TMP_4 = function(item){var self = TMP_4.$$s || this, $a;
if (item == null) item = nil;
      return $a = Opal.to_ary(self.$random_placement()), item['$x='](($a[0] == null ? nil : $a[0])), item['$y='](($a[1] == null ? nil : $a[1]))}, TMP_4.$$s = self, TMP_4), $a).call($b);
    };

    def.$draw = function(ctx) {
      var $a, $b, TMP_5, $c, TMP_6, $d, TMP_7, self = this;

      ($a = ($b = self.bg).$each, $a.$$p = (TMP_5 = function(item){var self = TMP_5.$$s || this, $a, $b, old_x = nil, old_y = nil;
if (item == null) item = nil;
      $a = [item.$x(), item.$y()], old_x = $a[0], old_y = $a[1];
        ...
        item.$draw(ctx);
        return $a = [old_x, old_y], item['$x=']($a[0]), item['$y=']($a[1]);}, TMP_5.$$s = self, TMP_5), $a).call($b);
      self.$draw_square(ctx, $hash2(["top_left", "bottom_right", "color", "width"], {"top_left": self.$offset(), "bottom_right": self.$pixels(), "color": "#736434", "width": 5}));
      ($a = ($c = self.$items()).$each, $a.$$p = (TMP_6 = function(item){var self = TMP_6.$$s || this, $a, $b, old_x = nil, old_y = nil;
if (item == null) item = nil;
      $a = [item.$x(), item.$y()], old_x = $a[0], old_y = $a[1];
        (($a = [$rb_plus(self.$offset_x(), item.$x())]), $b = item, $b['$x='].apply($b, $a), $a[$a.length-1]);
        (($a = [$rb_plus(self.$offset_y(), item.$y())]), $b = item, $b['$y='].apply($b, $a), $a[$a.length-1]);
        item.$draw(ctx);
        return $a = [old_x, old_y], item['$x=']($a[0]), item['$y=']($a[1]);}, TMP_6.$$s = self, TMP_6), $a).call($c);
      return ($a = ($d = self.$enemies()).$each, $a.$$p = (TMP_7 = function(enemy){var self = TMP_7.$$s || this, $a, $b, old_x = nil, old_y = nil;
if (enemy == null) enemy = nil;
      $a = [enemy.$x(), enemy.$y()], old_x = $a[0], old_y = $a[1];
        (($a = [$rb_plus(self.$offset_x(), enemy.$x())]), $b = enemy, $b['$x='].apply($b, $a), $a[$a.length-1]);
        (($a = [$rb_plus(self.$offset_y(), enemy.$y())]), $b = enemy, $b['$y='].apply($b, $a), $a[$a.length-1]);
        enemy.$draw(ctx);
        return $a = [old_x, old_y], enemy['$x=']($a[0]), enemy['$y=']($a[1]);}, TMP_7.$$s = self, TMP_7), $a).call($d);
    };

    def.$draw_square = function(ctx, opts) {
      var self = this;

      if (opts == null) {
        opts = $hash2([], {})
      }
      ctx.$draw_rect($hash2(["top_left", "width", "height", "color"], {"top_left": opts['$[]']("top_left"), "width": opts['$[]']("bottom_right")['$[]'](0), "height": opts['$[]']("width"), "color": opts['$[]']("color")}));
      ctx.$draw_rect($hash2(["top_left", "width", "height", "color"], {"top_left": opts['$[]']("top_left"), "width": opts['$[]']("width"), "height": opts['$[]']("bottom_right")['$[]'](1), "color": opts['$[]']("color")}));
      ctx.$draw_rect($hash2(["top_left", "width", "height", "color"], {"top_left": [opts['$[]']("top_left")['$[]'](0), $rb_plus(opts['$[]']("bottom_right")['$[]'](1), opts['$[]']("top_left")['$[]'](1))], "width": $rb_plus(opts['$[]']("bottom_right")['$[]'](0), opts['$[]']("width")), "height": opts['$[]']("width"), "color": opts['$[]']("color")}));
      return ctx.$draw_rect($hash2(["top_left", "width", "height", "color"], {"top_left": [$rb_plus(opts['$[]']("top_left")['$[]'](0), opts['$[]']("bottom_right")['$[]'](0)), opts['$[]']("top_left")['$[]'](1)], "width": opts['$[]']("width"), "height": $rb_plus(opts['$[]']("bottom_right")['$[]'](1), opts['$[]']("width")), "color": opts['$[]']("color")}));
    };

    def.$update = function(ctx) {
      var $a, $b, TMP_8, $c, TMP_9, self = this;

      ($a = ($b = self.$items()).$each, $a.$$p = (TMP_8 = function(item){var self = TMP_8.$$s || this, $a, $b, old_x = nil, old_y = nil;
if (item == null) item = nil;
      $a = [item.$x(), item.$y()], old_x = $a[0], old_y = $a[1];
        (($a = [$rb_plus(self.$offset_x(), item.$x())]), $b = item, $b['$x='].apply($b, $a), $a[$a.length-1]);
        (($a = [$rb_plus(self.$offset_y(), item.$y())]), $b = item, $b['$y='].apply($b, $a), $a[$a.length-1]);
        item.$update(ctx);
        return $a = [old_x, old_y], item['$x=']($a[0]), item['$y=']($a[1]);}, TMP_8.$$s = self, TMP_8), $a).call($b);
      return ($a = ($c = self.$enemies()).$each, $a.$$p = (TMP_9 = function(enemy){var self = TMP_9.$$s || this;
if (enemy == null) enemy = nil;
      return enemy.$update(ctx)}, TMP_9.$$s = self, TMP_9), $a).call($c);
    };
    ...
    def.$pixel_width = function() {
      ...
      return $rb_times(self.$width(), $scope.get('G').$tilesize());
    };

    def.$pixel_height = function() {
      var self = this;
...
Opal.modules["lib/item"] = function(Opal) {
  ...
  Opal.add_stubs(['$attr_accessor', '$new', '$downcase', '$draw', '$x', '$y', '$width', '$height', '$near_player?', '$pickup', '$player', '$set_item', '$include?', '$mid_x', '$mid_y']);
  return (function($base, $super) {
    function $Item(){};
    ...
    def.img = def.held = nil;
    self.$attr_accessor("x", "y", "height", "width", "name", "held");

    def.$initialize = function(name) {
      var self = this;

      self.font = (($scope.get('Dare')).$$scope.get('Font')).$new();
      self.height = self.width = 32;
      self.img = (($scope.get('Dare')).$$scope.get('Image')).$new("assets/" + (name.$downcase()) + ".png");
      return self.name = name;
    };
    ...
    def.$draw = function(ctx) {
      ...
      return self.img.$draw(self.$x(), self.$y());
    };
    ...
    def.$update = function(ctx) {
      ...
      if ((($a = ($b = self['$near_player?'](40), $b !== false && $b !== nil ?$scope.get('G').$player().$pickup() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
/* Generated by Opal 0.7.0.beta3 */
Opal.modules["lib/enemy"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  function $rb_gt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs > rhs : lhs['$>'](rhs);
  }
  ...
  Opal.add_stubs(['$attr_accessor', '$load_tiles', '$new', '$frames_loaded?', '$draw', '$[]', '$x', '$y', '$step_animation', '$==', '$rand', '$pixel_width', '$current_level', '$pixel_height', '$include?']);
  return (function($base, $super) {
    function $Enemy(){};
    ...
    def.height = def.walk = def.frames = def.current_frame = def.dir = def.x = def.y = nil;
    self.$attr_accessor("x", "y", "dislike");

    def.$initialize = function(x, y, dislike) {
      var self = this;
      ...
      self.height = 64;
      self.frames = self.$load_tiles("assets/baddie.png", $hash2(["width", "height"], {"width": self.height, "height": self.height}));
      self.walk = $scope.get('Animation').$new(0, 3);
      self.current_frame = 0;
      self.current_animation = self.walk;
      self.tick = 0;
      return self.dir = "fobar";
    };
    ...
    def.$draw = function(ctx) {
      ...
      if ((($a = self['$frames_loaded?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.frames['$[]'](self.current_frame).$draw(self.$x(), self.$y());
        return self.$step_animation();
        } else {
        return nil
      };
    };
    ...
    return (def.$update = function(ctx) {
      ...
      if (self.dir['$==']("left")) {
        if ($rb_gt(self.$x(), 0)) {
          self.x = $rb_minus(self.x, 1)
        } else if ($rb_gt(self.$rand(), 0.5)) {
          self.dir = "right"
          } else {
          self.dir = "up"
        }};
      if (self.dir['$==']("right")) {
        if ($rb_lt(self.$x(), $rb_minus($scope.get('G').$current_level().$pixel_width(), self.height))) {
          self.x = $rb_plus(self.x, 1)
        } else if ($rb_gt(self.$rand(), 0.5)) {
          self.dir = "up"
          } else {
          self.dir = "left"
      ...
      if (self.dir['$==']("up")) {
        if ($rb_gt(self.y, 0)) {
          self.y = $rb_minus(self.y, 1)}};
      if ($rb_lt(self.y, $rb_minus($scope.get('G').$current_level().$pixel_height(), self.height))) {
        return self.y = $rb_plus(self.y, 1)
      } else if ((($a = ["up", "left", "right"]['$include?'](self.dir)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return nil
      } else if ($rb_gt(self.$rand(), 0.5)) {
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$new', '$width', '$height', '$tilesize', '$set_items', '$sample', '$set_enemies', '$pixel_width', '$mid', '$track', '$set_level', '$set_player', '$set_camera', '$with_index', '$each_with_index', '$draw', '$x', '$camera', '$y', '$each_slice', '$update', '$run!']);
  self.$require("dare");
  self.$require("lib/unweapon"+ '/../' + "game");
  self.$require("lib/unweapon"+ '/../' + "camera");
  self.$require("lib/unweapon"+ '/../' + "utils/dir");
  self.$require("lib/unweapon"+ '/../' + "utils/animation");
  self.$require("lib/unweapon"+ '/../' + "utils/null");
  self.$require("lib/unweapon"+ '/../' + "sprite");
  self.$require("lib/unweapon"+ '/../' + "player");
  self.$require("lib/unweapon"+ '/../' + "level");
  self.$require("lib/unweapon"+ '/../' + "item");
  self.$require("lib/unweapon"+ '/../' + "enemy");
  Opal.cdecl($scope, 'G', $scope.get('Game').$new());
  Opal.cdecl($scope, 'Items', ["dirt", "milk", "coin"]);
  (function($base, $super) {
    function $Unweapon(){};
    var self = $Unweapon = $klass($base, $super, 'Unweapon', $Unweapon);

    var def = self.$$proto, $scope = self.$$scope, TMP_1;

    def.level = def.camera = def.player = def.bg = nil;
    def.$initialize = TMP_1 = function() {
      var $a, $b, TMP_2, $c, TMP_3, self = this, $iter = TMP_1.$$p, $yield = $iter || nil;

      TMP_1.$$p = null;
      Opal.find_super_dispatcher(self, 'initialize', TMP_1, null).apply(self, [$hash2(["width", "height", "border"], {"width": $scope.get('G').$width(), "height": $scope.get('G').$height(), "border": true})]);
      self.bg = ($a = ($b = $scope.get('Array')).$new, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

      return (($scope.get('Dare')).$$scope.get('Image')).$new("assets/bbwater.png")}, TMP_2.$$s = self, TMP_2), $a).call($b, $rb_times(($rb_times(($rb_divide($scope.get('G').$width(), $scope.get('G').$tilesize())), ($rb_divide($scope.get('G').$height(), $scope.get('G').$tilesize())))), 4));
      self.level = $scope.get('Level').$new(0, 0, 12, 10);
      self.level.$set_items(($a = ($c = $scope.get('Array')).$new, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

      return $scope.get('Item').$new($scope.get('Items').$sample())}, TMP_3.$$s = self, TMP_3), $a).call($c, 10));
      self.level.$set_enemies($scope.get('Enemy').$new($rb_divide(self.level.$pixel_width(), 2)));
      ...
      return $scope.get('G').$set_camera(self.camera);
    };

    def.$draw = function() {
      var $a, $b, TMP_4, self = this;

      ($a = ($b = self.bg.$each_slice($rb_times(($rb_divide($scope.get('G').$width(), $scope.get('G').$tilesize())), 2))).$with_index, $a.$$p = (TMP_4 = function(row, r_index){var self = TMP_4.$$s || this, $a, $b, TMP_5;
if (row == null) row = nil;if (r_index == null) r_index = nil;
      return ($a = ($b = row).$each_with_index, $a.$$p = (TMP_5 = function(tile, c_index){var self = TMP_5.$$s || this, _x = nil, _y = nil;
if (tile == null) tile = nil;if (c_index == null) c_index = nil;
        _x = $rb_times(c_index, $scope.get('G').$tilesize());
          _y = $rb_times(r_index, $scope.get('G').$tilesize());
          return tile.$draw($rb_minus($rb_plus(_x, $scope.get('G').$camera().$x()), $scope.get('G').$width()), $rb_minus($rb_plus(_y, $scope.get('G').$camera().$y()), $scope.get('G').$height()));}, TMP_5.$$s = self, TMP_5), $a).call($b)}, TMP_4.$$s = self, TMP_4), $a).call($b);
      self.level.$draw(self);
      return self.player.$draw(self);
    };
